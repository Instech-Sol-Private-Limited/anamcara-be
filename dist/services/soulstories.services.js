...
exports.soulStoriesServices = void 0;
...
class GeminiService {
    ...
    generateThumbnailSuggestions(content) {
...
${content}`;
                    ...
                    return Object.assign(Object.assign({}, parsed), { rawResponse });
                }
                catch (err) {
                    console.error(`Gemini API Key ${this.currentKeyIndex} failed:`, err.message);
                    lastError = err;
                    // If current key fails, try next key immediately
                    this.currentKeyIndex = (this.currentKeyIndex + 1) % this.keys.length;
                }
            }
            throw new Error(`All Gemini API keys failed. Last error: ${lastError === null || lastError === void 0 ? void 0 : lastError.message}`);
        });
    }
    parseGeminiResponse(response) {
        ...
        return {
            title: ((_a = titleMatch === null || titleMatch === void 0 ? void 0 : titleMatch[1]) === null || _a === void 0 ? void 0 : _a.trim()) || 'Untitled Story',
            description: ((_b = descriptionMatch === null || descriptionMatch === void 0 ? void 0 : descriptionMatch[1]) === null || _b === void 0 ? void 0 : _b.trim()) || 'An engaging story'
        };
    }
    generateMultipleSuggestions(content_1) {
        return __awaiter(this, arguments, void 0, function* (content, count = 3) {
            const suggestions = [];
            for (let i = 0; i < count; i++) {
                try {
                    const suggestion = yield this.generateThumbnailSuggestions(content);
                    suggestions.push({
...
const getReactionCounts = (targetId, targetType) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { data: reactions, error } = yield app_1.supabase
        ...
        reactions === null || reactions === void 0 ? void 0 : reactions.forEach(reaction => {
            switch (reaction.type) {
                case 'like':
                    ...
                    break;
                case 'dislike':
                    counts.total_dislikes++;
                    break;
                case 'insightful':
                    counts.total_insightfuls++;
                    break;
                case 'heart':
                    counts.total_hearts++;
                    break;
...
class GrammarCorrector {
    ...
    processParagraph(paragraph_1) {
        return __awaiter(this, arguments, void 0, function* (paragraph, maxChunkSize = 500) {
            var _a, _b, _c;
            if (!paragraph.trim()) {
                return {
            ...
            try {
                ...
                const response = yield fetch('https://api.languagetool.org/v2/check', {
                    method: 'POST',
                    headers: {
                ...
                const sortedMatches = filteredMatches.sort((a, b) => b.offset - a.offset);
                ...
                for (const match of sortedMatches) {
                    ...
                    if (match.replacements && match.replacements.length > 0) {
                        ...
                        corrections.push({
                            ...
                            ruleId: ((_a = match.rule) === null || _a === void 0 ? void 0 : _a.id) || match.ruleId,
                            offset: match.offset,
                            pass: 1
                        });
                        ...
                        if (((_b = match.rule) === null || _b === void 0 ? void 0 : _b.issueType) === 'misspelling') {
                            ...
                            if (correctedWord !== originalWord) {
                                ...
                                corrections.push({
                                    ...
                                    ruleId: ((_c = match.rule) === null || _c === void 0 ? void 0 : _c.id) || "SPELLING_RULE",
                                    offset: match.offset,
                                    pass: 1
                                });
                            }
    ...
    suggestSpellingCorrection(word) {
...
exports.soulStoriesServices = {
    createStory: (storyData_1, ...args_1) => __awaiter(void 0, [storyData_1, ...args_1], void 0, function* (storyData, episodes = [], userId) {
        try {
            console.log('Attempting to insert:', storyData);
            // Create a clean copy without co_authors first (for backward compatibility)
            const { co_authors } = storyData, baseStoryData = __rest(storyData, ["co_authors"]);
            // Only add co_authors if it's a valid non-empty array
            const finalStoryData = Object.assign(Object.assign({}, baseStoryData), (co_authors && Array.isArray(co_authors) && co_authors.length > 0 && { co_authors }));
    ...
    getAnalytics: (userId) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            // EXISTING: Get stories where user is main author (unchanged)
            const { data: analyticsData, error: analyticsError } = yield app_1.supabase
                .from('soul_stories')
                .select('*')
                .eq('author_id', userId);
            ...
            let coAuthorStories = [];
            try {
                const { data: coAuthorData, error: coAuthorError } = yield app_1.supabase
                    .from('soul_stories')
                    .select('*')
            ...
            const mainAuthorStories = analyticsData || [];
    ...
    getStories: (userId, type, options) => __awaiter(void 0, void 0, void 0, function* () {
        try {
      ...
      `, { count: 'exact' });
            ...
            const { data: stories, error, count } = yield query;
            if (error) {
            ...
            const transformedStories = (stories || []).map(story => {
                if (story.content_type === 'episodes' && story.soul_story_episodes) {
                    ...
                    return Object.assign(Object.assign({}, story), { main_url: story.asset_url, episode_urls: story.soul_story_episodes.map((ep) => ({
                    ...
                    return Object.assign(Object.assign({}, story), { main_url: story.asset_url, episode_urls: null // No episodes
                     });
                }
            });
            const total = count || 0;
            ...
            if (storyIds.length > 0) {
                ...
                if (userId) {
                    const { data: userReactionData } = yield app_1.supabase
                        .from('soul_story_reactions')
                        .select('target_id, type')
                        .eq('user_id', userId)
                        .eq('target_type', 'story')
                    ...
                    userReactionData === null || userReactionData === void 0 ? void 0 : userReactionData.forEach(reaction => {
                ...
                storyIds.forEach(storyId => {
                    commentCounts[storyId] = (comments === null || comments === void 0 ? void 0 : comments.filter(c => c.soul_story_id === storyId).length) || 0;
                });
                // Calculate reaction counts for each story
                storyIds.forEach(storyId => {
                    const storyReactions = (reactions === null || reactions === void 0 ? void 0 : reactions.filter(r => r.target_id === storyId)) || [];
            ...
            const storiesWithReactions = transformedStories.map(story => {
                ...
                return (Object.assign(Object.assign({}, story), { total_likes: ((_a = reactionCounts[story.id]) === null || _a === void 0 ? void 0 : _a.total_likes) || 0, total_dislikes: ((_b = reactionCounts[story.id]) === null || _b === void 0 ? void 0 : _b.total_dislikes) || 0, total_hearts: ((_c = reactionCounts[story.id]) === null || _c === void 0 ? void 0 : _c.total_hearts) || 0, total_souls: ((_d = reactionCounts[story.id]) === null || _d === void 0 ? void 0 : _d.total_souls) || 0, total_insightfuls: ((_e = reactionCounts[story.id]) === null || _e === void 0 ? void 0 : _e.total_insightfuls) || 0, total_hugs: ((_f = reactionCounts[story.id]) === null || _f === void 0 ? void 0 : _f.total_hugs) || 0, user_reaction: userReactions[story.id] || null, total_comments: commentCounts[story.id] || 0, total_shares: story.total_shares || 0, total_views: story.total_views || 0 // ← This is already available from the story data
                 }));
            });
    ...
    deleteStory(userId, story_id) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Check if story exists and user owns it
                const { data: story, error: checkError } = yield app_1.supabase
                    .from('soul_stories')
                    .select('id, author_id')
                    .eq('id', story_id)
                    .single();
                ...
                const { error: episodesError } = yield app_1.supabase
                    .from('soul_story_episodes')
                    .delete()
                ...
                const { error: storyError } = yield app_1.supabase
                    .from('soul_stories')
                    .delete()
                    .eq('id', story_id);
                if (storyError) {
    ...
    purchaseContent: (userId, storyId, contentData) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const { data: existingAccess, error: accessError } = yield app_1.supabase
                .from('user_content_purchases')
                .select('*')
                .eq('user_id', userId)
                .eq('story_id', storyId)
                .single();
            let currentHighestPage = (existingAccess === null || existingAccess === void 0 ? void 0 : existingAccess.highest_page_access) || 0;
            let currentEpisodes = (existingAccess === null || existingAccess === void 0 ? void 0 : existingAccess.accessible_episode_urls) || [];
            let totalSpent = (existingAccess === null || existingAccess === void 0 ? void 0 : existingAccess.total_coins_spent) || 0;
            let totalRevenue = (existingAccess === null || existingAccess === void 0 ? void 0 : existingAccess.author_revenue) || 0;
            ...
            const { data: upsertData, error: accessUpdateError } = yield app_1.supabase
                .from('user_content_purchases')
                .upsert({
                user_id: userId,
                story_id: storyId,
            ...
            const { data: userCoins, error: userError } = yield app_1.supabase
                .from('anamcoins')
            ...
            const { error: userUpdateError } = yield app_1.supabase
                .from('anamcoins')
                .update({
            ...
            if (hasCoAuthors) {
                ...
                for (let i = 0; i < allAuthors.length; i++) {
                    ...
                    const { data: authorCoins, error: authorError } = yield app_1.supabase
                        .from('anamcoins')
                    ...
                    const { error: authorUpdateError } = yield app_1.supabase
                        .from('anamcoins')
                        .update({
    ...
    getStoryAccess: (userId, storyId) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            // Get story details
            const { data: story, error: storyError } = yield app_1.supabase
                .from('soul_stories')
            ...
            const { data: userAccess } = yield app_1.supabase
            ...
            if (story.asset_type === 'document') {
                ...
                const totalAccessiblePages = story.free_pages + ((userAccess === null || userAccess === void 0 ? void 0 : userAccess.highest_page_access) || 0);
                return {
                    story_id: storyId,
                    ...
                    story_type: 'PDF',
                    free_pages: story.free_pages,
                    purchased_pages: (userAccess === null || userAccess === void 0 ? void 0 : userAccess.highest_page_access) || 0,
                    total_accessible_pages: totalAccessiblePages,
                    total_coins_spent: (userAccess === null || userAccess === void 0 ? void 0 : userAccess.total_coins_spent) || 0,
                    author_revenue: (userAccess === null || userAccess === void 0 ? void 0 : userAccess.author_revenue) || 0
                };
            }
            else if (story.asset_type === 'video') {
                // Video Story - Return accessible episode URLs
                const accessibleEpisodes = (userAccess === null || userAccess === void 0 ? void 0 : userAccess.accessible_episode_urls) || [];
    ...
    getUserRevenue: (userId) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            // Get all stories created by the user
            const { data: userStories, error: storiesError } = yield app_1.supabase
                .from('soul_stories')
            ...
            const { data: purchases, error: purchasesError } = yield app_1.supabase
            ...
            const storyRevenue = userStories.map(story => {
                const storyPurchases = (purchases === null || purchases === void 0 ? void 0 : purchases.filter(p => p.story_id === story.id)) || [];
                ...
                const episodesSold = storyPurchases.reduce((sum, p) => { var _a; return sum + (((_a = p.accessible_episode_urls) === null || _a === void 0 ? void 0 : _a.length) || 0); }, 0);
                return {
                    story_id: story.id,
                    story_title: story.title,
                    story_category: story.category,
    ...
    searchAllContent: (query, category, userId, storyId) => __awaiter(void 0, void 0, void 0, function* () {
        try {
        ...
        `, { count: 'exact' });
            ...
            const { data: stories, error, count } = yield supabaseQuery;
            if (error) {
            ...
            console.log('Raw stories found:', (stories === null || stories === void 0 ? void 0 : stories.length) || 0);
    ...
    createComment: (userId_1, soulStoryId_1, content_1, ...args_1) => __awaiter(void 0, [userId_1, soulStoryId_1, content_1, ...args_1], void 0, function* (userId, soulStoryId, content, imgs = []) {
        try {
            console.log('Searching for soul story with ID:', soulStoryId);
            // First, let's check if the story exists at all
            const { data: storyData, error: storyError } = yield app_1.supabase
                .from('soul_stories')
            ...
            try {
                const { data: deletedCheck } = yield app_1.supabase
                    .from('soul_stories')
                    .select('is_deleted')
                    .eq('id', soulStoryId)
                    .single();
                if ((deletedCheck === null || deletedCheck === void 0 ? void 0 : deletedCheck.is_deleted) === true) {
    ...
    createReply: (userId_1, commentId_1, content_1, ...args_1) => __awaiter(void 0, [userId_1, commentId_1, content_1, ...args_1], void 0, function* (userId, commentId, content, imgs = []) {
        try {
    ...
    getComments: (soulStoryId_1, ...args_1) => __awaiter(void 0, [soulStoryId_1, ...args_1], void 0, function* (soulStoryId, page = 1, limit = 10, userId) {
        try {
            const offset = (page - 1) * limit;
            const { data: comments, error, count } = yield app_1.supabase
                .from('soul_story_comments')
                .select('*', { count: 'exact' })
            ...
            if (userId && comments) {
                const commentsWithReactions = yield Promise.all(comments.map((comment) => __awaiter(void 0, void 0, void 0, function* () {
                    const { data: reactionData } = yield app_1.supabase
                        ...
                        .maybeSingle();
                    return Object.assign(Object.assign({}, comment), { user_reaction: (reactionData === null || reactionData === void 0 ? void 0 : reactionData.type) || null });
                })));
                return {
                    success: true,
                    data: {
    ...
    getCommentsWithReplies: (soulStoryId_1, ...args_1) => __awaiter(void 0, [soulStoryId_1, ...args_1], void 0, function* (soulStoryId, page = 1, limit = 10, userId) {
        try {
            const offset = (page - 1) * limit;
            ...
            if (userId && comments) {
                const commentsWithReplies = yield Promise.all(comments.map((comment) => __awaiter(void 0, void 0, void 0, function* () {
                    ...
                    const { data: commentReaction } = yield app_1.supabase
                        .from('soul_story_reactions')
                        .select('type')
                        .eq('user_id', userId)
                        .eq('target_id', comment.id)
                    ...
                    const repliesWithReactions = yield Promise.all((replies || []).map((reply) => __awaiter(void 0, void 0, void 0, function* () {
                        const { data: replyReaction } = yield app_1.supabase
                            .from('soul_story_reactions')
                            .select('type')
                            .eq('user_id', userId)
                            ...
                            .eq('target_type', 'comment')
                            .maybeSingle();
                        return Object.assign(Object.assign({}, reply), { user_reaction: (replyReaction === null || replyReaction === void 0 ? void 0 : replyReaction.type) || null });
                    })));
                    return Object.assign(Object.assign({}, comment), { user_reaction: (commentReaction === null || commentReaction === void 0 ? void 0 : commentReaction.type) || null, replies: repliesWithReactions });
                })));
                return {
                    success: true,
                    data: {
    ...
    updateComment: (userId_1, commentId_1, content_1, ...args_1) => __awaiter(void 0, [userId_1, commentId_1, content_1, ...args_1], void 0, function* (userId, commentId, content, imgs = []) {
        try {
            const { data: commentData, error: fetchError } = yield app_1.supabase
                .from('soul_story_comments')
                .select('user_id')
                .eq('id', commentId)
                .eq('is_deleted', false)
    ...
    deleteComment: (userId, commentId) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { data: commentData, error: fetchError } = yield app_1.supabase
                .from('soul_story_comments')
                .select('user_id')
    ...
    updateCommentReaction: (userId, commentId, type) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            if (existing) {
                if (existing.type === type) {
                    updates[currentField] = Math.max(0, commentData[currentField] - 1);
                    const { error: deleteError } = yield app_1.supabase
                        .from('soul_story_reactions')
                        .delete()
                        .eq('id', existing.id);
                ...
                updates[prevField] = Math.max(0, commentData[prevField] - 1);
                updates[currentField] = commentData[currentField] + 1;
    ...
    updateStoryReaction: (userId, storyId, type) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            if (existing) {
                if (existing.type === type) {
                    ...
                    const reactionCounts = yield getReactionCounts(storyId, 'story');
                    return {
                        success: true,
    ...
    getStoryWithReactions: (storyId, userId) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            if (userId) {
                const { data: reactionData } = yield app_1.supabase
                    ...
                    .eq('target_type', 'story')
                    .maybeSingle();
                userReaction = (reactionData === null || reactionData === void 0 ? void 0 : reactionData.type) || null;
            }
            // Get reaction counts from reactions table instead of story table
            const reaction_counts = yield getReactionCounts(storyId, 'story');
            ...
            return {
                success: true,
                data: Object.assign(Object.assign({}, story), { reaction_counts, user_reaction: userReaction, 
    ...
    getCommentReactions: (commentId, userId) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            let userReaction = null;
            if (userId) {
                const userReactionData = reactions === null || reactions === void 0 ? void 0 : reactions.find(r => r.user_id === userId);
                userReaction = (userReactionData === null || userReactionData === void 0 ? void 0 : userReactionData.type) || null;
            }
            // Calculate reaction counts
            const reaction_counts = {
                total_likes: (reactions === null || reactions === void 0 ? void 0 : reactions.filter(r => r.type === 'like').length) || 0,
                total_dislikes: (reactions === null || reactions === void 0 ? void 0 : reactions.filter(r => r.type === 'dislike').length) || 0,
                total_insightfuls: (reactions === null || reactions === void 0 ? void 0 : reactions.filter(r => r.type === 'insightful').length) || 0,
                total_hearts: (reactions === null || reactions === void 0 ? void 0 : reactions.filter(r => r.type === 'heart').length) || 0,
                total_hugs: (reactions === null || reactions === void 0 ? void 0 : reactions.filter(r => r.type === 'hug').length) || 0,
                total_souls: (reactions === null || reactions === void 0 ? void 0 : reactions.filter(r => r.type === 'soul').length) || 0,
            };
            // Get users who reacted (with profile data)
            const userIds = (reactions === null || reactions === void 0 ? void 0 : reactions.map(r => r.user_id)) || [];
            let usersWithReactions = [];
            if (userIds.length > 0) {
                ...
                usersWithReactions = (reactions === null || reactions === void 0 ? void 0 : reactions.map(reaction => {
                    const userProfile = userProfiles === null || userProfiles === void 0 ? void 0 : userProfiles.find(p => p.id === reaction.user_id);
                    return {
    ...
    //   }
    // },
    getTrendingStories: (userId_1, ...args_1) => __awaiter(void 0, [userId_1, ...args_1], void 0, function* (userId, page = 1, limit = 200) {
        try {
            const offset = (page - 1) * limit;
            // Get all stories first with active_status filter
            const { data: stories, error, count } = yield app_1.supabase
                .from('soul_stories')
                .select(`
          *,
          soul_story_episodes(
        ...
        `, { count: 'exact' })
            ...
            const transformedStories = (stories === null || stories === void 0 ? void 0 : stories.map(story => {
                if (story.content_type === 'episodes' && story.soul_story_episodes) {
                    // For episode-based stories, return main URL + episode URLs (EXACTLY like getStories)
                    return Object.assign(Object.assign({}, story), { main_url: story.asset_url, episode_urls: story.soul_story_episodes.map((ep) => ({
                            episode_number: ep.episode_number,
            ...
            if (storyIds.length > 0) {
                ...
                storyIds.forEach(storyId => {
                    const storyReactions = (reactions === null || reactions === void 0 ? void 0 : reactions.filter(r => r.target_id === storyId)) || [];
                    const storyComments = (commentData === null || commentData === void 0 ? void 0 : commentData.filter(c => c.soul_story_id === storyId)) || [];
                    reactionCounts[storyId] = {
                        total_likes: storyReactions.filter(r => r.type === 'like').length,
                        total_dislikes: storyReactions.filter(r => r.type === 'dislike').length,
                        total_insightfuls: storyReactions.filter(r => r.type === 'insightful').length,
            ...
            const storiesWithEngagement = transformedStories.map(story => {
                ...
                return Object.assign(Object.assign({}, story), { total_likes: reactions.total_likes || 0, total_dislikes: reactions.total_dislikes || 0, total_insightfuls: reactions.total_insightfuls || 0, total_hearts: reactions.total_hearts || 0, total_hugs: reactions.total_hugs || 0, total_souls: reactions.total_souls || 0, user_reaction: userReactions[story.id] || null, total_comments: commentCount, total_views: story.total_views || 0, total_shares: story.total_shares || 0, total_engagement: totalEngagement, total_reactions: totalReactions });
            });
    ...
    getEpisodeAccess: (userId, storyId, episodeId) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            // Get episode details
            const { data: episode, error: episodeError } = yield app_1.supabase
                .from('soul_story_episodes')
                .select('*')
                .eq('id', episodeId)
    ...
    boostSoulStory: (userId, storyId, boostType) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const { data: userCoins, error: coinsError } = yield app_1.supabase
            ...
            // Create boost record
            const { error: boostError } = yield app_1.supabase
            ...
            const { error: storyUpdateError } = yield app_1.supabase
                .from('soul_stories')
                .update({
                is_boosted: true,
    ...
    getUserSoulStoryBoosts: (userId) => __awaiter(void 0, void 0, void 0, function* () {
        try {
    ...
    getProductDetails: (storyId) => __awaiter(void 0, void 0, void 0, function* () {
        var _a, _b, _c;
        try {
            const { data: story, error: storyError } = yield app_1.supabase
                .from('soul_stories')
        ...
        `)
            ...
            const { data: earnedCoins, error: coinsError } = yield app_1.supabase
                .from('user_content_purchases')
                .select('coins_paid')
                .eq('story_id', storyId);
            const totalEarnedCoins = (earnedCoins === null || earnedCoins === void 0 ? void 0 : earnedCoins.reduce((sum, purchase) => sum + (purchase.coins_paid || 0), 0)) || 0;
            // Get boost status
            const { data: boostData, error: boostError } = yield app_1.supabase
                .from('soul_story_boosts')
                .select('*')
                .eq('story_id', storyId)
                .order('created_at', { ascending: false })
            ...
            const productDetails = {
                ...
                creator_name: `${((_a = story.author) === null || _a === void 0 ? void 0 : _a.first_name) || ''} ${((_b = story.author) === null || _b === void 0 ? void 0 : _b.last_name) || ''}`.trim(),
                creator_avatar: (_c = story.author) === null || _c === void 0 ? void 0 : _c.avatar_url,
                price: story.price || 0,
    ...
    getAllUsersStoriesData: () => __awaiter(void 0, void 0, void 0, function* () {
        try {
            // Get all users
            const { data: users, error: usersError } = yield app_1.supabase
                .from('profiles')
                .select(`
          id,
          first_name,
        ...
        `)
            ...
            for (const user of users || []) {
                // Get user's stories
                const { data: stories, error: storiesError } = yield app_1.supabase
                    .from('soul_stories')
                    .select('*')
                ...
                const videoStories = userStories.filter(story => story.asset_type === 'video' || story.story_type === 'episodes').length;
                const pdfStories = userStories.filter(story => story.asset_type === 'document').length;
                // Get boost count for this user
                const { data: boosts, error: boostsError } = yield app_1.supabase
                    .from('soul_story_boosts')
                    .select('*')
                    .eq('user_id', user.id);
                const boostCount = (boosts === null || boosts === void 0 ? void 0 : boosts.length) || 0;
                const activeBoosts = (boosts === null || boosts === void 0 ? void 0 : boosts.filter(boost => new Date(boost.boost_end) > new Date()).length) || 0;
                // Calculate total revenue from all stories
                const { data: purchases, error: purchasesError } = yield app_1.supabase
                    .from('user_content_purchases')
                    .select('coins_paid')
                    .in('story_id', userStories.map(story => story.id));
                const totalRevenue = (purchases === null || purchases === void 0 ? void 0 : purchases.reduce((sum, purchase) => sum + (purchase.coins_paid || 0), 0)) || 0;
                usersData.push({
                    user_id: user.id,
    ...
    createStoryReport: (userId, storyId, reportContent, reportReason) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const { data: existingReport, error: checkError } = yield app_1.supabase
            ...
            // Create the report
            const { data: report, error: reportError } = yield app_1.supabase
                .from('soul_story_reports')
                .insert([{
                    story_id: storyId,
                    reporter_id: userId,
    ...
    getStoryReports: (storyId) => __awaiter(void 0, void 0, void 0, function* () {
        try {
        ...
        `)
            ...
            const reportCounts = (reports === null || reports === void 0 ? void 0 : reports.reduce((acc, report) => {
            ...
            return {
                ...
                data: {
                    reports: reports || [],
                    report_summary: {
                        total_reports: (reports === null || reports === void 0 ? void 0 : reports.length) || 0,
    ...
    getUserFriends: (userId) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            ...
            const formatted = friendsData
                .filter((profile) => profile.id !== userId) // EXCLUDE current user
                .map((profile) => {
    ...
    generateThumbnailSuggestions: (content) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            return yield geminiService.generateThumbnailSuggestions(content);
        }
        catch (error) {
    ...
    generateMultipleSuggestions: (content_1, ...args_1) => __awaiter(void 0, [content_1, ...args_1], void 0, function* (content, count = 3) {
        try {
            return yield geminiService.generateMultipleSuggestions(content, count);
        }
        catch (error) {
    ...
    updateStory: (storyId_1, updateData_1, ...args_1) => __awaiter(void 0, [storyId_1, updateData_1, ...args_1], void 0, function* (storyId, updateData, episodes = [], userId) {
        try {
            // First, check if story exists and user has permission to update
            const { data: existingStory, error: checkError } = yield app_1.supabase
                .from('soul_stories')
                .select('author_id, co_authors')
                .eq('id', storyId)
                .single();
            ...
            // Create a clean copy without co_authors first (for backward compatibility)
            const { co_authors } = updateData, baseUpdateData = __rest(updateData, ["co_authors"]);
            let finalUpdateData = Object.assign(Object.assign(Object.assign({}, baseUpdateData), (co_authors && Array.isArray(co_authors) && co_authors.length > 0 && { co_authors })), { updated_at: new Date().toISOString() });
            // Handle episodes update - preserve existing episodes and update only provided ones
            if (episodes && episodes.length > 0) {
                // Get existing episodes first
                const { data: existingEpisodes, error: existingEpisodesError } = yield app_1.supabase
                    .from('soul_story_episodes')
                ...
                const existingEpisodesMap = new Map(existingEpisodes.map(ep => [ep.episode_number, ep.id]));
            ...
            const { data: updatedStory, error: updateError } = yield app_1.supabase
                .from('soul_stories')
    ...
    correctGrammar: (text_1, ...args_1) => __awaiter(void 0, [text_1, ...args_1], void 0, function* (text, maxChunkSize = 500) {
        try {
            const cleanText = text.trim();
            const words = cleanText.split(/\s+/).filter(word => word.length > 0);
            if (words.length === 1) {
                // Single word - check spelling only (keep using LanguageTool)
                const result = yield exports.soulStoriesServices.checkSingleWordSpelling(cleanText);
                return {
                    success: true,
                    data: {
...
Corrected text:`;
                ...
                const result = yield geminiService.generateThumbnailSuggestions(cleanText);
                const correctedText = result.rawResponse.trim();
                console.log(`Original: "${cleanText}"`);
                console.log(`Corrected: "${correctedText}"`);
                // Generate corrections array based on differences
                const corrections = exports.soulStoriesServices.generateCorrections(cleanText, correctedText);
                return {
                    success: true,
                    data: {
                        originalText: cleanText,
                ...
                const result = yield corrector.processParagraph(cleanText, maxChunkSize);
                return {
                    success: true,
                    data: {
    ...
    checkSingleWordSpelling: (word) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const response = yield fetch('https://api.languagetool.org/v2/check', {
                method: 'POST',
                headers: {
    ...
    generateCorrections: (original, corrected) => {
        const corrections = [];
    ...
    checkPdfQualityFromBucket: (pdfUrl) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            console.log(`Checking PDF quality: ${pdfUrl}`);
            if (pdfUrl.startsWith('/uploads/pdfs/')) {
                try {
                    const fullPath = path_1.default.join(__dirname, '../../', pdfUrl);
                    ...
                    const pdfBuffer = fs_1.default.readFileSync(fullPath);
                    ...
                    const readabilityAnalysis = exports.soulStoriesServices.analyzeReadability(pdfText);
                    const qualityScore = exports.soulStoriesServices.calculateQualityScore(readabilityAnalysis);
    ...
    shareStory: (userId_1, storyId_1, ...args_1) => __awaiter(void 0, [userId_1, storyId_1, ...args_1], void 0, function* (userId, storyId, shareType = 'general') {
        try {
            // Check if story exists
            const { data: story, error: storyError } = yield app_1.supabase
                .from('soul_stories')
    ...
    analyzeReadability: (text) => {
        try {
            ...
            const readabilityScore = Math.max(0, Math.min(100, 206.835 - (1.015 * avgSentenceLength) - (84.6 * (complexWords / wordCount * 100))));
    ...
    calculateQualityScore: (analysis) => {
        try {
            ...
            if (complexWordPercentage > 20)
                score -= 10;
            else if (analysis.complexWords / analysis.wordCount > 0.15)
                score -= 5;
    ...
    purchaseAIToolAccess: (userId, toolType, coinsRequired) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { data: userCoins, error: userError } = yield app_1.supabase
                .from('anamcoins')
                .select('available_coins, spent_coins, total_coins')
            ...
            const { error: upsertError } = yield app_1.supabase
                .from('ai_tools_usage')
                .upsert({
                user_id: userId,
                tool_type: toolType,
            ...
            const { error: coinUpdateError } = yield app_1.supabase
                .from('anamcoins')
                .update({
    ...
    checkAIToolAccess: (userId, toolType) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const { data: usageData, error } = yield app_1.supabase
                .from('ai_tools_usage')
                .select('*')
                .eq('user_id', userId)
    ...
    recordAIToolUsage: (userId, toolType) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            // First get current usage count
            const { data: currentUsage, error: fetchError } = yield app_1.supabase
                .from('ai_tools_usage')
                .select('usage_count')
                .eq('user_id', userId)
                .eq('tool_type', toolType)
            ...
            const newUsageCount = ((currentUsage === null || currentUsage === void 0 ? void 0 : currentUsage.usage_count) || 0) + 1;
