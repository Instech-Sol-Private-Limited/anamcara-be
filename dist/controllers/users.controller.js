...
const sendApprovalEmail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield (0, mailer_1.sendAdminEmail)(email, invitorName, '', status);
        if (userId) {
            const { data: user, error: userError } = yield app_1.supabase
                .from('profiles')
                .select('email')
