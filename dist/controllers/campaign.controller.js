...
const createCampaign = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const { title, visuals, soulWords, goalType, goalAmount, baseAmount, endDate, category, verification, description, campaignType, matchChallenges, offeredProduct, acceptedCurrencies } = req.body;
