...
exports.getMarketplaceBoosts = exports.getUserBoosts = exports.getActiveBoosts = exports.getActiveFeaturedProducts = exports.createBoost = exports.deleteReview = exports.updateReview = exports.createReview = exports.getProductReviews = exports.getUserReviews = exports.voteOnReview = exports.completeResale = exports.initiateResale = exports.getMyLibraryProducts = exports.processPurchase = exports.deleteProduct = exports.updateProduct = exports.getProductDetails = exports.getAllProductsForAdmin = exports.getApprovedProducts = exports.getProductsByUser = exports.createDigitalAsset = void 0;
...
const createDigitalAsset = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { title, description, tags, category, priceAnamCoins, redeemAccessBonus, license, assets, thumbnail, creatorId, disclaimers } = req.body;
        ...
        const { data: product, error: dbError } = yield app_1.supabase
            .from('products')
            .insert({
            title,
            description,
...
const getProductsByUser = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { data: products, error: productsError } = yield app_1.supabase
            .from('products')
            .select(`
        *,
        creator:profiles (
      ...
      `)
        ...
        const productIds = (products === null || products === void 0 ? void 0 : products.map(p => p.id)) || [];
        ...
        if (productIds.length > 0) {
            ...
            if (boostsError) {
                ...
                boosts === null || boosts === void 0 ? void 0 : boosts.forEach(boost => {
                    boostedProductsMap.set(boost.product_id, boost);
                });
            }
        }
        // Enhance products with boost information
        const productsWithBoost = (products === null || products === void 0 ? void 0 : products.map(product => {
            const boostData = boostedProductsMap.get(product.id);
            return Object.assign(Object.assign({}, product), { is_boosted: !!boostData, boost_details: boostData || null });
        })) || [];
        res.status(200).json({
            success: true,
...
//   }
// };
const getApprovedProducts = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const { search, tags, sortBy = 'created_at', sortOrder = 'desc' } = req.query;
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
        let baseQuery = app_1.supabase
            .from('products')
            .select(`
        *,
        creator:profiles (
      ...
      `)
        ...
        const { data: allProducts, error } = yield baseQuery;
        if (error) {
            throw new Error(`Database error: ${error.message}`);
        }
        if (!userId || !allProducts || allProducts.length === 0) {
            const transformedProducts = (allProducts === null || allProducts === void 0 ? void 0 : allProducts.map(product => {
                var _a, _b, _c, _d, _e;
                return (Object.assign(Object.assign({}, product), { creator_id: ((_a = product.creator) === null || _a === void 0 ? void 0 : _a.id) || product.creator_id, creator: {
                        first_name: ((_b = product.creator) === null || _b === void 0 ? void 0 : _b.first_name) || null,
                        last_name: ((_c = product.creator) === null || _c === void 0 ? void 0 : _c.last_name) || null,
                        email: ((_d = product.creator) === null || _d === void 0 ? void 0 : _d.email) || null,
                        avatar_url: ((_e = product.creator) === null || _e === void 0 ? void 0 : _e.avatar_url) || null
                    } }));
            })) || [];
        ...
        const { data: userPreferences } = yield app_1.supabase
            ...
            .eq('user_id', userId)
            .single();
        const userKeywords = (userPreferences === null || userPreferences === void 0 ? void 0 : userPreferences.product_keywords) || {};
        const productsWithScores = allProducts.map(product => {
            ...
            return Object.assign(Object.assign({}, product), { preferenceScore,
                averageRating,
                newnessScore });
        });
        ...
        if (finalProducts.length < totalProducts) {
            const remainingProducts = productsWithScores.filter(product => !finalProducts.includes(product));
...
const getAllProductsForAdmin = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
      ...
      `)
        ...
        const transformedProducts = (products === null || products === void 0 ? void 0 : products.map(product => {
            var _a, _b, _c, _d, _e;
            return (Object.assign(Object.assign({}, product), { creator_id: ((_a = product.creator) === null || _a === void 0 ? void 0 : _a.id) || product.creator_id, creator: {
                    first_name: ((_b = product.creator) === null || _b === void 0 ? void 0 : _b.first_name) || null,
                    last_name: ((_c = product.creator) === null || _c === void 0 ? void 0 : _c.last_name) || null,
...
const getProductDetails = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { data: product, error } = yield app_1.supabase
            .from('products')
            .select(`
        *,
        creator:profiles (
      ...
      `)
        ...
        const transformedProduct = Object.assign(Object.assign({}, product), { creator_id: ((_a = product.creator) === null || _a === void 0 ? void 0 : _a.id) || product.creator_id, creator: {
                first_name: ((_b = product.creator) === null || _b === void 0 ? void 0 : _b.first_name) || null,
                last_name: ((_c = product.creator) === null || _c === void 0 ? void 0 : _c.last_name) || null,
                email: ((_d = product.creator) === null || _d === void 0 ? void 0 : _d.email) || null,
                avatar_url: ((_e = product.creator) === null || _e === void 0 ? void 0 : _e.avatar_url) || null
...
const updateProduct = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const { id: productId } = req.params;
        const { title, description, tags, priceAnamCoins, redeemAccessBonus, // Changed
        visibility, license, assets, thumbnail, // Added
        status } = req.body;
        const userRole = (_a = req.user) === null || _a === void 0 ? void 0 : _a.role;
        const { data: existingProduct, error: fetchError } = yield app_1.supabase
            .from('products')
            .select('*')
            .eq('id', productId)
            .single();
        ...
        const isCreator = ((_b = req.user) === null || _b === void 0 ? void 0 : _b.id) === existingProduct.creator_id;
        ...
        const { data: updatedProduct, error: updateError } = yield app_1.supabase
            .from('products')
            .update(updateData)
            .eq('id', productId)
            .select()
...
const processPurchase = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
        const { productId, purchaseType, recipientId, currencyType } = req.body;
        // Validate request
        ...
        if (productError || !product) {
            throw new Error((productError === null || productError === void 0 ? void 0 : productError.message) || 'Product not found');
        }
        ...
        const { data: buyerProfile } = yield app_1.supabase
            .from('profiles')
        ...
        if (currencyType === 'AC') {
            yield (0, products_service_1.processAnamCoinsTransaction)(userId, price);
            yield (0, products_service_1.recordAnamCoinsHistory)({
                userId,
                coinsSpent: price,
            ...
            yield (0, products_service_1.processAccessBonusTransaction)(userId, spAmount);
            yield (0, products_service_1.recordSoulPointsHistory)({
                userId,
        ...
        const { data: buyerTransaction, error: buyerTxError } = yield app_1.supabase
        ...
        if (buyerTxError || !buyerTransaction) {
            throw new Error((buyerTxError === null || buyerTxError === void 0 ? void 0 : buyerTxError.message) || 'Failed to create buyer transaction record');
        }
        // 2. Create seller's transaction (if not self-purchase)
        if (product.creator && product.creator.id !== userId) {
            const { error: sellerTxError } = yield app_1.supabase
                .from('product_transactions')
                .insert({
                product_id: productId,
                buyer_id: userId,
            ...
            if (currencyType === 'AC') {
                yield app_1.supabase.rpc('increment_anam_coins', {
                ...
                const spAmount = price * 100;
                yield app_1.supabase.rpc('increment_soul_points', {
                    user_id: product.creator.id,
                    amount: spAmount
                });
                yield (0, products_service_1.recordSoulPointsHistory)({
        ...
        if (purchaseType === 'gift' && recipientId) {
            ...
            const { data: recipientProfile } = yield app_1.supabase
                .from('profiles')
                .select('id, first_name, last_name, email')
                .eq('id', recipientId)
                .single();
...
const getMyLibraryProducts = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { data: libraryItems, error: libraryError } = yield app_1.supabase
            .from('my_library')
            .select(`
        *,
        product:products (
      ...
      `)
        ...
        const transformedItems = (libraryItems === null || libraryItems === void 0 ? void 0 : libraryItems.map(item => {
            var _a;
            return ({
                id: item.id,
                product: Object.assign(Object.assign({}, item.product), { creator: ((_a = item.product) === null || _a === void 0 ? void 0 : _a.creator) || null }),
...
const initiateResale = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
        if (!userId) {
        ...
        const { libraryItemId, newPrice, currencyType } = req.body;
        ...
        const { data: libraryItem, error: fetchError } = yield app_1.supabase
            .from('my_library')
            .select(`
        *,
        product:products (
      ...
      `)
        ...
        if (fetchError || !libraryItem) {
            throw new Error((fetchError === null || fetchError === void 0 ? void 0 : fetchError.message) || 'Library item not found');
        }
...
exports.initiateResale = initiateResale;
const completeResale = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c;
    try {
        const userId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
        if (!userId) {
      ...
      `)
        ...
        const resalePrice = ((_b = libraryItem.product) === null || _b === void 0 ? void 0 : _b.price_anam_coins) || 0;
        // Process payment from buyer to seller
        yield (0, products_service_1.processAnamCoinsTransaction)(buyerId, resalePrice);
        // Credit seller (original owner)
        const { data: sellerAnamCoins, error: sellerFetchError } = yield app_1.supabase
            .from('anamcoins')
            .select('*')
            .eq('user_id', userId)
            .single();
        if (sellerFetchError || !sellerAnamCoins) {
            throw new Error((sellerFetchError === null || sellerFetchError === void 0 ? void 0 : sellerFetchError.message) || 'Seller Anam Coins account not found');
        }
        const { error: creditError } = yield app_1.supabase
            .from('anamcoins')
            .update({
        ...
        if (transactionError || !transaction) {
            throw new Error((transactionError === null || transactionError === void 0 ? void 0 : transactionError.message) || 'Failed to create resale transaction');
        }
        // Add to buyer's library
        const { error: buyerLibraryError } = yield app_1.supabase
            .from('my_library')
            .insert({
            user_id: buyerId,
            product_id: libraryItem.product_id,
            transaction_id: transaction.id,
            license_type: ((_c = libraryItem.product) === null || _c === void 0 ? void 0 : _c.license) || 'personal'
        });
        if (buyerLibraryError) {
            throw new Error(buyerLibraryError.message);
        }
        // Mark original item as resold
        const { error: markResoldError } = yield app_1.supabase
            .from('my_library')
            .update({
            is_resold: true,
...
exports.completeResale = completeResale;
// -------------- Product reviews API --------------
const getProductReviews = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const { data: reviews, error: reviewsError, count } = yield app_1.supabase
            .from('reviews')
            .select(`
      id,
      rating,
    ...
    `, { count: 'exact' })
        ...
        const { data: stats, error: statsError } = yield app_1.supabase
        ...
        // Format reviews data
        const formattedReviews = (reviews === null || reviews === void 0 ? void 0 : reviews.map((review) => {
            var _a, _b;
            return ({
                id: review.id,
                ...
                user: {
                    id: (_a = review.user) === null || _a === void 0 ? void 0 : _a.id,
                    name: review.user
                        ? `${review.user.first_name || ''} ${review.user.last_name || ''}`.trim()
                        : 'Anonymous',
                    avatar: ((_b = review.user) === null || _b === void 0 ? void 0 : _b.avatar_url) || null
                }
            });
        })) || [];
...
const createReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { data: existingReview, error: existingError } = yield app_1.supabase
            .from('reviews')
            .select('id')
            .eq('product_id', productId)
            .eq('user_id', userId)
        ...
        // Create the review
        const { data: newReview, error: createError } = yield app_1.supabase
            .from('reviews')
            .insert({
            product_id: productId,
            user_id: userId,
        ...
        const formattedReview = {
            ...
            user: {
                id: (_b = newReview.user) === null || _b === void 0 ? void 0 : _b.id,
                name: newReview.user ? `${newReview.first_name || ''} ${newReview.last_name || ''}`.trim() : 'Anonymous',
                avatar: newReview.avatar_url || null
            }
        };
        res.status(201).json({
            success: true,
...
const updateReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { data: existingReview, error: checkError } = yield app_1.supabase
            .from('reviews')
            .select('id, user_id')
            .eq('id', reviewId)
            .eq('status', 'active')
        ...
        // Update the review
        const { data: updatedReview, error: updateError } = yield app_1.supabase
            .from('reviews')
            .update(updateData)
            .eq('id', reviewId)
            .select(`
      ...
      `)
        ...
        const formattedReview = {
            ...
            user: {
                id: (_b = updatedReview.user) === null || _b === void 0 ? void 0 : _b.id,
                name: updatedReview.user
                    ? `${updatedReview.user.first_name || ''} ${updatedReview.user.last_name || ''}`.trim()
                    : 'Anonymous',
                avatar: ((_c = updatedReview.user) === null || _c === void 0 ? void 0 : _c.avatar_url) || null
            }
        };
        res.json({
            success: true,
...
const voteOnReview = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    try {
        const { reviewId } = req.params;
        ...
        const { data: review, error: reviewError } = yield app_1.supabase
            .from('reviews')
            .select('id, user_id')
            .eq('id', reviewId)
            .eq('status', 'active')
        ...
        const { data: existingVote, error: voteError } = yield app_1.supabase
            .from('review_votes')
            .select('id, vote_type')
        ...
        if (existingVote) {
            ...
            // Create new vote
            const { error: createError } = yield app_1.supabase
                .from('review_votes')
                .insert({
                review_id: reviewId,
                user_id: userId,
        ...
        const { data: updatedReview, error: fetchError } = yield app_1.supabase
            .from('reviews')
    ...
    try {
        ...
        const formattedReviews = (reviews === null || reviews === void 0 ? void 0 : reviews.map(review => {
            ...
            return ({
                ...
                date: review.created_at,
                product: {
                    id: (_a = review.product[0]) === null || _a === void 0 ? void 0 : _a.id,
                    title: (_b = review.product[0]) === null || _b === void 0 ? void 0 : _b.title,
                    thumbnail: ((_d = (_c = review.product[0]) === null || _c === void 0 ? void 0 : _c.thumbnail) === null || _d === void 0 ? void 0 : _d[0]) || null
                }
            });
        })) || [];
        res.json({
...
const createBoost = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { data: result, error: transactionError } = yield app_1.supabase.rpc('create_boost_transaction', {
            p_user_id: userId,
...
exports.getUserBoosts = getUserBoosts;
...
exports.getMarketplaceBoosts = getMarketplaceBoosts;
...
exports.getActiveFeaturedProducts = getActiveFeaturedProducts;
