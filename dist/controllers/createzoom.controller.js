...
exports.createBooking = exports.getUserSlots = exports.updateAvailability = exports.getAvailability = void 0;
...
const getZoomAccessToken = () => __awaiter(void 0, void 0, void 0, function* () {
    const credentials = Buffer.from(`${ZOOM_CONFIG.clientId}:${ZOOM_CONFIG.clientSecret}`).toString('base64');
...
const createZoomMeeting = (meetingData) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const response = yield fetch(`${ZOOM_CONFIG.apiBaseUrl}/users/me/meetings`, {
        method: 'POST',
        headers: {
...
const generateBrandedLink = (zoomUrl) => {
...
const validateBookingRequest = (data) => {
    ...
    if (((_a = data.slot) === null || _a === void 0 ? void 0 : _a.start) && !timeRegex.test(data.slot.start)) {
        errors.push('Invalid start time format');
    }
    if (((_b = data.slot) === null || _b === void 0 ? void 0 : _b.end) && !timeRegex.test(data.slot.end)) {
...
const createBooking = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const { data: buyerData, error: buyerError } = yield app_1.supabase
            .from('profiles')
        ...
        const { data: existingBookings, error: conflictError } = yield app_1.supabase
        ...
        const { data: savedMeeting, error: saveError } = yield app_1.supabase
            .from('scheduled_meetings')
        ...
        if (saveError) {
            ...
            try {
                const accessToken = yield getZoomAccessToken();
                yield fetch(`${ZOOM_CONFIG.apiBaseUrl}/meetings/${zoomMeeting.id}`, {
                    method: 'DELETE',
                    headers: {
                        'Authorization': `Bearer ${accessToken}`,
                    },
