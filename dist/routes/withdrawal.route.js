...
router.post("/setup-withdrawal-account", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.get("/check-account-status/:userId", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
router.post("/account-dashboard/:userId", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { userId } = req.params;
        const { data: userAccount } = yield app_1.supabase
            .from('user_accounts')
...
router.get("/onboarding-return", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
